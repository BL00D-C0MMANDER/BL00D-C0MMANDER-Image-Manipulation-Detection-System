...
resultLabel = Label(text="IMAGE MANIPULATION DETECTOR", font=("Comforta", 50),fg="#3e068e",bg="#b2f6f6")
resultLabel.grid(row=0, column=0, columnspan=6)
...
s = ttk.Style()
s.configure('my.TButton', font=('Comforta', 15))
...
style = ttk.Style()
style.configure('W.TButton', font = ('Comforta', 15, 'bold'),foreground = 'red')
